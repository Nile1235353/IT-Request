...
<head>
    ...
    <title>Job Launched Service Request</title>
</head>
                    ...
                    <tr>
                        <td align="center" style="padding: 20px 30px 20px 30px; background-color: #00559C; color: #ffffff; border-bottom: 1px solid #e0e0e0;">
                            <h1 style="margin: 0; font-size: 24px; font-weight: bold;">
                                Software Request Job Launched Submitted
                            </h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 30px 30px 20px 30px; color: #333333; font-size: 14px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px;">
                                **System Notification:** software service request Job Launched requires your attention.
                            </p>

                            <table border="0" cellpadding="10" cellspacing="0" width="100%" style="border-collapse: collapse; border: 1px solid #eeeeee;">
                                <tr>
                                    <td style="background-color: #f9f9f9; width: 30%;"><strong>Job Done Date:</strong></td>
                                    <td style="background-color: #f9f9f9;">{{ $requestData['launched_date'] }}</td>
                                </tr>
                                <tr>
                                    <td style="width: 30%;"><strong>Tester:</strong></td>
                                    <td>{{ $requestData['testers'] }}</td>
                                </tr>
                                <!-- <tr>
                            ...
                            <p style="text-align: center; margin: 30px 0;">
                                <a href="{{ url('/feedback/' . $requestData['id']) }}" 
