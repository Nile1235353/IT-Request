                    ...
                    <tr>
                        <td style="padding: 30px 30px 20px 30px; color: #333333; font-size: 14px;">
                            <p style="margin: 0 0 20px 0; font-size: 16px;">
                                **System Notification:** A new software service request requires your attention.
                            </p>

                            <table border="0" cellpadding="10" cellspacing="0" width="100%" style="border-collapse: collapse; border: 1px solid #eeeeee;">
                                <tr>
                                    <td style="background-color: #f9f9f9; width: 30%;"><strong>Requester Name:</strong></td>
                                    <td style="background-color: #f9f9f9;">{{ $requestData['Requester_Name'] }}</td>
                                </tr>
                                <tr>
                                    <td style="width: 30%;"><strong>Employee ID:</strong></td>
                                    <td>{{ $requestData['Employee_ID'] }}</td>
                                </tr>
                                <tr>
                                    <td style="background-color: #f9f9f9;"><strong>Department:</strong></td>
                                    <td style="background-color: #f9f9f9;">{{ $requestData['Department'] }}</td>
                                </tr>
                                <tr>
